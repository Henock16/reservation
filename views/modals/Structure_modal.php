<div class="row">
	<div class="modal fade" id="modal-structure" style="z-index: 1401;padding-left:0px;margin-left:0px;" data-backdrop="static">
		<div class="modal-dialog lg" role="document" style="border-radius: 3px;width:700px;">
			<div class="modal-content">
				<div class="modal-header" id="modal-structure-header">
					<h4 class="modal-title lead" style="font-weight: bold;color:white" id="modal-structure-title"></h4>
				...
				<div class="modal-body" style="overflow-y:hidden;">
					...
					<div class="form-group row" id="nom"style="margin-top:0px;margin-bottom:0px;">
						...
						<div class="input-group col-sm-8"  style="float:right">
							<input type="text" class="form-control structure-details" name="nom" placeholder="" style="height:30px" required/>
						</div>
                    </div> 
				</div>
				<div class="modal-footer">
					<button type="submit" id="submit-structure" class="btn btn-success pull-center"></button>
