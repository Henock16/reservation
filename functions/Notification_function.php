...
<<<<<<< HEAD
	...
	$inspecteur=$inspecteur.(($telephone)?" (".$telephone.")":"");

	$sujet=(($action==3)?"REJET DE RESERVATION D'INSPECTEUR POUR UNE ":(($action==5)?"ANNULATION D'":"")."AFFECTATION D'UN INSPECTEUR A UNE ")."OPERATION DE PESEES SUR ".strtoupper($site);
	if($action==3)
		$message="Votre demande d'inspecteur sur <b>".$site."</b> pour la <b>".$plage."</b> du <b>".$reserv."</b> a été rejetée.";
	else if($action==5)
		$message="L'affectation de l'inspecteur <b>".$inspecteur."</b> sur <b>".$site."</b> pour la <b>".$plage."</b> du <b>".$reserv."</b> a été annulée.";
	else
